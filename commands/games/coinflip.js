...
module.exports = {
	callback: async ({ message, args }) => {
		...
		if (coinsOwned < args[1]) return message.channel.send(`Du hast doch gar keine ${args[1]} 💵!`);
