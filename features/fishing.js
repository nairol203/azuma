...
module.exports.addBait_1 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
...
module.exports.addBait_2 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
...
module.exports.addBait_3 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
...
module.exports.useBait_1 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
...
module.exports.useBait_2 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
...
module.exports.useBait_3 = async (userId, bait) => {
    await profile.findOneAndUpdate(
        {
            userId,
        },
